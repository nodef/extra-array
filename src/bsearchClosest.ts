...
function bsearchClosestCompare<T>(x: T[], v: T, fn: compareFn<T>=null): number {
  var fn = fn||cmp;
 ...
 */
function bsearchClosest<T, U=T>(x: T[], v: T, fc: compareFn<T|U>=null, fm: mapFn<T, T|U>=null): number {
